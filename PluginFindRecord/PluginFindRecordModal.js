...
const RESULTS_HEADER = <FormattedMessage id="ui-plugin-rs-siquery-folio.resultsHeader" />;
...
class PluginFindRecordModal extends React.Component {
  ...
  render() {
    ...
    const resultsStatusMessage = source
      ...
      : <FormattedMessage id="ui-plugin-rs-siquery-folio.noSourceYet" />;
      ...
      <div className={css.pluginModalFooter}>
        ...
        {isMultiSelect && (
          <>
            <div>
              <FormattedMessage
                id="ui-plugin-rs-siquery-folio.totalSelected"
